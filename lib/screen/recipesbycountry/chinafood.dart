      ...
      child: Scaffold(
        body: ListView(
          children: <Widget>[
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (ctx, i) => Row(
                        children: <Widget>[
                          ...
                          _buildStory(italy.italyRecipes.sublist(1)[i].imageUrl,
                              italy.italyRecipes.sublist(1)[i].country),
                          _buildStory(china.chinaRecipes.sublist(1)[i].imageUrl,
            ...
            _buildText('Best Dishes To Eat  ', 'in China'),
            Container(
              height: height * 0.7,
              color: Colors.white,
              child: ListView.builder(
                ...
                itemBuilder: (ctx, i) => ChangeNotifierProvider.value(
                    ...
                    child: ChangeNotifierProvider.value(
                        value: china.chinaRecipes[i], child: ChinaWidget())),
              ),
            )
          ],
        ),
