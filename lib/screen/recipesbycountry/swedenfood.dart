...
class SwedenCountry extends StatefulWidget {
  static const routeName = 'SW';

  @override
  _SwedenCountryState createState() => _SwedenCountryState();
}

class _SwedenCountryState extends State<SwedenCountry> {
  Widget _buildStory(
    String image,
    String title,
  ) {
      ...
      child: Scaffold(
        body: ListView(
          children: <Widget>[
            ...
            _buildText('Best Dishes To Eat  ', 'in Sweden'),
            Container(
              height: height * 0.7,
              color: Colors.white,
              child: ListView.builder(
